...
ActiveRecord::Schema.define(version: 20190518100807) do
  ...
  create_table "playinfos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "user_id"
    t.bigint "question_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["question_id"], name: "index_playinfos_on_question_id"
    t.index ["user_id"], name: "index_playinfos_on_user_id"
  end
  ...
  add_foreign_key "playinfos", "questions"
  add_foreign_key "playinfos", "users"
